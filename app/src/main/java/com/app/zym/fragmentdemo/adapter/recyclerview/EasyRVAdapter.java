...
import com.app.zym.fragmentdemo.adapter.helper.DataHelper;
...
public abstract class EasyRVAdapter<T> extends RecyclerView.Adapter<BaseRVHolder> implements DataHelper<T> {
    /****
     * 头部相关
     */
    ...
    public BaseRVHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if(mHeaderView != null && viewType == TYPE_HEADER){
            return new BaseRVHolder(mContext, headerViewId, mHeaderView);
        }
        if(mHeaderView != null && viewType == TYPE_FOOTER){
            return new BaseRVHolder(mContext, footerViewId, mFooterView);
        }
            ...
            gridManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
                ...
                public int getSpanSize(int position) {
                    if(getItemViewType(position) == TYPE_HEADER || getItemViewType(position) == TYPE_FOOTER){
                        ...
                        for (Map.Entry<Integer, Integer> inputType : layoutType.entrySet()) {
                            if(getItemViewType(position) == inputType.getKey()){
    ...
    private Map<Integer,Integer> layoutType;
    public void setLayoutType(Map<Integer,Integer> layoutType){
        this.layoutType = layoutType;
    }
    public void setLayoutType(int typeKey, int typeValue){
        layoutType = new HashMap<>();
        layoutType.put(typeKey, typeValue);
    }
