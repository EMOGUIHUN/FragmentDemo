...
public abstract class BaseLVAdapte<T> extends BaseAdapter implements DataHelper<T> {
    ...
    public BaseLVAdapte(Context context, List<T> list, int... layoutIds) {
    ...
    public BaseLVAdapte(Context context, List<T> list) {
        this.mContext = context;
        this.mList = list;
        this.mLInflater = LayoutInflater.from(mContext);
    }
    ...
    public abstract void convert(BaseLVHolder holder, int position, T t);
